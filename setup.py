...
setup(
  name = 'Topsis_Puneet_102003135',         # How you named your package folder (MyLib)
  packages = ['Topsis_Puneet_102003135'],   # Chose the same as "name"
  ...
  author = 'Puneet Kaur',                   # Type in your name
  author_email = 'pkaur1_be20@thapar.edu',      # Type in your E-Mail
